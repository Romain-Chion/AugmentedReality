========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet OpenGL_Haptic_Base
========================================================================

AppWizard a cr&eacute;&eacute; cette application OpenGL_Haptic_Base pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application OpenGL_Haptic_Base.


OpenGL_Haptic_Base.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; OpenGL_Haptic_Base.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
